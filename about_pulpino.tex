...
\item The above command will execute and invoke the Modelsim GUI but there is a chance of it throwing an error like the following \Cref{fig:modelsim_error}.
